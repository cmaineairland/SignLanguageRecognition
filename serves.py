...
LastEditTime: 2024-05-06 20:29:56
...
def get_LabelList():
    ...
    if (now_model_name == 'default_model'):
        use_list = [
...
def get_net_path():
    global now_model_name
    net_path = os.path.join(os.getcwd(), 'MyModels', now_model_name,
                            now_model_name, 'NetWork.pth')
    return net_path
...
def Select_reference_image():
    ...
    if (char == 'sp'):
        ...
        char = char[0:1]
    path = os.path.join(os.getcwd(), 'MyModels', now_model_name,
                        now_model_name, 'picture', f'{char}.jpg')
...
def get_massage():
    ...
    if massage_type == 'model_select':
        global now_model_name
        now_model_name = data.get('model_name')
        message = 'success'
    print(now_model_name)
